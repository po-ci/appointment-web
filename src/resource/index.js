...
import SpecificsScheduleProviderClass from '../modules/appointment/resource/SpecificsScheduleProvider'
...
export const SpecificsScheduleProvider = new SpecificsScheduleProviderClass('/zfmc/api/specifics-schedule')
